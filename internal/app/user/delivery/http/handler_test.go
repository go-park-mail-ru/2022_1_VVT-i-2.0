...
func TestUserHandler_Login(t *testing.T) {
	...
	json := `{"name":"Name","phone":"79999999999","email":"email@mail.com","avatar":"avatar/avatar.png","address":""}
`
	err = handler.Login(c)
...
func TestUserHandler_Login_Err(t *testing.T) {
	...
	mockUCase := new(mock.UserUcaseDBErr)
	mockAuthManager := new(mockAuth.AuthManager)
...
func TestUserHandler_Login_UnknownErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")

	mockUCase := new(mock.UserUcaseUnknownErr)
	mockAuthManager := new(mockAuth.AuthManager)
	mockLogger := new(mockLogger.Logger)
	e := echo.New()
...
func TestUserHandler_Register_UnknownErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_SendCode_UnknownErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_UpdateUser_UnknownErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_GetUser_UnknownErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_Login_TokenErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")

	mockUCase := new(mock.UserUcase)
	mockAuthManager := new(mockAuth.AuthManagerErr)
	mockLogger := new(mockLogger.Logger)
	e := echo.New()
...
func TestUserHandler_Register_TokenErr(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_BadReqLogin(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_BadReqRegister(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_BadReqSendCode(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_BadReqUpdateUser(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
...
func TestUserHandler_BadBodyLogin(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
	...
	req, err := http.NewRequest(echo.POST, "/login", strings.NewReader(string(`"bad":"req"`)))
	assert.NoError(t, err)
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
...
func TestUserHandler_BadBodyRegister(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
	...
	req, err := http.NewRequest(echo.POST, "/register", strings.NewReader(string(`"bad":"req"`)))
	assert.NoError(t, err)
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
...
func TestUserHandler_BadBaodeSendCode(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
	...
	req, err := http.NewRequest(echo.POST, "/send_code", strings.NewReader(string(`"bad":"req"`)))
	assert.NoError(t, err)
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
...
func TestUserHandler_BadBodyUpdateUser(t *testing.T) {
	staticManager := localStaticManager.NewLocalFileManager("", "")
	...
	req, err := http.NewRequest(echo.POST, "/update", strings.NewReader(string(`"bad":"req"`)))
