...
func (u *RestaurantsUsecase) GetRestaurantBySearchQuery(query models.GetRestaurantBySearchQueryUcaseReq) (*models.RestaurantsUcase, error) {
	query.Query = strings.Trim(query.Query, " \n\t")
	restaurantsData, err := u.RestaurantsRepo.GetRestaurantsBySeachQuery(models.GetRestaurantBySearchQueryRepoReq(query))
	if err != nil {
		return nil, errors.Wrapf(err, "error getting restaurants")
	}
