...
func (u *RecommendationsUcase) GetRecommendations(req *models.RecommendationsUcaseReq) (*models.RecommendationsUcaseResp, error) {
	return &models.RecommendationsUcaseResp{
...
func (u *RecommendationsUcaseErr) GetRecommendations(req *models.RecommendationsUcaseReq) (*models.RecommendationsUcaseResp, error) {
