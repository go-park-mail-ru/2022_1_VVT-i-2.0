...
func TestUserUseCase_Login(t *testing.T) {
	...
	expectResp := &models.LogitUcaseResp{
		Id:     1,
		Name:   "Name",
		Phone:  "79999999999",
...
func TestUserUseCase_SendCodeErr(t *testing.T) {
	mockUserRepo := new(mock.AuthRepo)
	mockCacher := new(mockCacher.Memcacher)
	mockNotificator := new(mockNatificator.NotificatorErr)
	ucase := NewAuthUcase(mockNotificator, mockCacher, mockUserRepo)
	...
	var expectResp models.SendCodeUcaseResp
