...
func (u *AuthRepo) GetTopUserAddr(req *models.GetTopUserAddrRepoReq) (*models.GetTopUserAddrRepoResp, error) {
	return &models.GetTopUserAddrRepoResp{Address: "адрес"}, nil
}
